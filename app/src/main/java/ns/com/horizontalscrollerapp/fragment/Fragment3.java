...
public class Fragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mStartScene = Scene.getSceneForLayout(rootLayout, R.layout.view_pager_item_default_pf, getContext());
        mInfoScene = Scene.getSceneForLayout(rootLayout, R.layout.view_pager_item_details_pf, getContext());
